...
#include "../library/histogram.h"
#include "../library/simulationElts.h"
#include "cpu-timer.h"
...
main(int argc,char* argv[])
{
    if(argc != 3)
    {
        std::cerr << "Usage: test0 <Number of runs> <Number of time steps>\n";
        return 1;
    }
...
*/
    int noRuns = 1 << atoi(argv[1]);
    int noTimesteps = atoi(argv[2]);
...
//    time_t start=time(0);
    ...
    double elapsed_time = timer.secs();
    std::cout << "Took " << elapsed_time << " seconds\n";
